...
import static com.digitfaber.messaging.TestSubscriber.INCORRECT_LISTENER_MESSAGE_NAME
import static com.digitfaber.messaging.TestSubscriber.MESSAGE_NAME

@SpringBootTest(classes = TestApplication)
class MessagePublisherIntegrationSpec extends Specification {
